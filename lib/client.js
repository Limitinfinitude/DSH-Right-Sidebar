	...
	*/
	(function(root, factory) {
		...
		function getWorkerBlob() {
			...
			return Papa$1.BLOB_URL || (Papa$1.BLOB_URL = URL.createObjectURL(new Blob([
...
function SvgPreview({ entry, content, labels }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MediaPreview, {
		kind: "svg",
		source: (0, react.useMemo)(() => prepareSvg(entry.path, sanitizeSvg(content)), [content, entry.path]),
		alt: entry.path,
		labels,
		onLoad: () => {},
		onError: () => {}
...
function ImagePreview({ entry, onResult, labels }) {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MediaPreview, {
		kind: "image",
		source: fileUrl(entry.path, entry.lastSeq),
		alt: entry.path,
		labels,
		onLoad: () => {
			onResult({
...
function PdfPreview({ entry, onResult, labels }) {
