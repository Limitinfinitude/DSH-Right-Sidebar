...
function OutputDockSurface(props) {
	...
	const filtered = (0, react.useMemo)(() => filterCatalog(catalog, catalogQuery), [catalog, catalogQuery]);
					...
					catalogOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							groups.map((group) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								}), group.entries.map((entry) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
									type: "button",
									className: "dsh-od-catalog-item",
									role: "option",
									"aria-selected": entry.path === selectedPath,
